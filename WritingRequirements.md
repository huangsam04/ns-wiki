---
title: 书写说明
description: 本说明旨在规范Wiki编辑流程与内容管理。编辑需获取正式成员权限，且资源来源于网络，侵权需联系删除。创建页面时，路径应使用英文且无空格，标题需填写中文，每页仅限一个一级标题以优化搜索索引。素材上传需存入指定基础文件夹，并注意调整图片尺寸。
published: true
date: 2026-02-14T13:04:01.447Z
tags: 
editor: markdown
